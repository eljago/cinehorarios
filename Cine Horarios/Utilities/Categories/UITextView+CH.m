...
//  Cine Horarios
//
//  Created by Arturo Espinoza Carrasco on 17-01-15.
...
- (CGFloat)measureHeightUsingFont:(UIFont *)textViewFont
{
    if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1)
    {
        ...
        NSDictionary *attributes = @{ NSFontAttributeName: textViewFont, NSParagraphStyleAttributeName : paragraphStyle };
...
- (CGFloat)measureAttributedTextViewHeight
{
    if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1)
    {
        ...
        NSAttributedString *textToMeasure = self.attributedText;
